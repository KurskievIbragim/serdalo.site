                ...
                <div v-else>
                    <form @submit.prevent="store">
                        <div class="p-6">
                            ...
                            <text-input v-model="form.release_at" :error="errors.release_at" id="release_at" label="Дата выпуска" />
                            <file-input
                                :files="files"
        ...
        methods: {
            setData() {
                ...
                .then(res => {
                    ...
                    this.form.title = res.data.newspaper.title
                    this.form.release_at = res.data.newspaper.release_at
                    this.form.status = res.data.newspaper.status
                    this.form.file_id = res.data.newspaper.file_id
