...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/documents/' + this.$route.params.document_id + '/documents_translations/create')
                .then(res => {
            ...
            store() {
                ...
                axios.post('/api/admin/documents/' + this.$route.params.document_id + '/documents_translations', this.form)
                .then(res => {
                    this.errors = {}
