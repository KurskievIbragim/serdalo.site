                    ...
                    <form @submit.prevent="store">
                        <div class="p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <button-primary type="button" @click="openFilesModal()" class="flex">
...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/experts/' + this.$route.params.id + '/edit')
                .then(res => {
                    this.form.title = res.data.expert.title
                    this.form.description = res.data.expert.description
                    this.form.file_id = res.data.expert.file_id
            ...
            store() {
                ...
                axios.put('/api/admin/experts/' + this.$route.params.id, this.form)
                .then(res => {
                    this.errors = {}
