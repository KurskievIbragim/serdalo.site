...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/materials/' + this.$route.params.material_id + '/materials_translations/create')
                .then(res => {
            ...
            store() {
                ...
                axios.post('/api/admin/materials/' + this.$route.params.material_id + '/materials_translations', this.form)
                .then(res => {
                    this.errors = {}
