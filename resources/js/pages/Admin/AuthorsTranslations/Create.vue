...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/authors/' + this.$route.params.author_id + '/authors_translations/create')
                .then(res => {
            ...
            store() {
                ...
                axios.post('/api/admin/authors/' + this.$route.params.author_id + '/authors_translations', this.form)
                .then(res => {
                    this.errors = {}
