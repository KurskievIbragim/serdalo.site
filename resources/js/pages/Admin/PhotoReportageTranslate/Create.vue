<template>
    <div>
        <h1 class="px-8 font-semibold text-xl text-gray-800 leading-tight">
            Переводы фоторепортажей / Создание
        </h1>
        <div class="px-8 py-8">
...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/photoreportage/' + this.$route.params.reportage_id + '/photo_reportage_translations/create')
                .then(res => {
            ...
            store() {
                ...
                axios.post('/api/admin/photoreportage/' + this.$route.params.reportage_id + '/photo_reportage_translations', this.form)
                .then(res => {
                    this.errors = {}
