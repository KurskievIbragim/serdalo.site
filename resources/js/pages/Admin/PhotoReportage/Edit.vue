...
<script>
    ...
    export default {
        ...
        methods: {
            setData() {
                axios.get('/api/admin/photoreportage/' + this.$route.params.id + '/edit')
                .then(res => {
            ...
            store() {
                ...
                axios.put('/api/admin/photoreportage/' + this.$route.params.id, this.form)
                .then(res => {
                    this.errors = {}
